...
type SockRequest struct {
	...
	//	*SockRequest_Sock
	//	*SockRequest_Data
	Content isSockRequest_Content `protobuf_oneof:"content"`
}
...
func (*SockRequest) Descriptor() ([]byte, []int) {
	return file_core_api_tcp_proto_rawDescGZIP(), []int{2}
}

func (m *SockRequest) GetContent() isSockRequest_Content {
	if m != nil {
		return m.Content
	}
	return nil
...
func (x *SockRequest) GetSock() *Sock {
	if x, ok := x.GetContent().(*SockRequest_Sock); ok {
		return x.Sock
	}
	return nil
}
...
func (x *SockRequest) GetData() *SockData {
	if x, ok := x.GetContent().(*SockRequest_Data); ok {
		return x.Data
	}
	return nil
}

type isSockRequest_Content interface {
	isSockRequest_Content()
}

type SockRequest_Sock struct {
	Sock *Sock `protobuf:"bytes,1,opt,name=sock,proto3,oneof"`
}

type SockRequest_Data struct {
	Data *SockData `protobuf:"bytes,2,opt,name=data,proto3,oneof"`
}

func (*SockRequest_Sock) isSockRequest_Content() {}

func (*SockRequest_Data) isSockRequest_Content() {}
...
var file_core_api_tcp_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x2e, 0x0a, 0x04, 0x53, 0x6f, 0x63,
	...
	,
...
var file_core_api_tcp_proto_goTypes = []interface{}{
	...
	(*Sock)(nil),        // 1: api.Sock
	(*SockRequest)(nil), // 2: api.SockRequest
}
var file_core_api_tcp_proto_depIdxs = []int32{
	1, // 0: api.SockRequest.sock:type_name -> api.Sock
	0, // 1: api.SockRequest.data:type_name -> api.SockData
	2, // 2: api.TCPCaller.TCPCall:input_type -> api.SockRequest
...
func file_core_api_tcp_proto_init() {
	...
	file_core_api_tcp_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*SockRequest_Sock)(nil),
		(*SockRequest_Data)(nil),
	}
	type x struct{}
